 ...
 *
 * Description:
 * The Library modal: manage the user's local semantic library — upload PDFs /
...
/**
 * Render the Library modal: upload/paste, per-file progress, the source list.
 *
 * A centred dialog over the workspace, the same shell Settings uses. It was
 * a right-hand drawer to v7.8.0 and a main-pane view that hid the workspace
 * from then to v7.32.0; the modal keeps the view's one virtue — the graph and
 * the conversation stay mounted and untouched behind it — while the rail's
 * two management entries, Library and Settings, now open the same kind of
 * thing.
 *

...
| [03](03_targeted-rerating/README.md) | The high-endorsement nots are calibration misses only where the paper is big in its own right: blind stronger raters relabel the 2,220-citer survey, not the three one-big-citer artifacts | 30-row blind sheet: 4 feature-nominated nots among 26 uniform decoys; 2–3 deeper raters, told nothing of the nomination; per-rater labels, never merged | *hypothesis written; awaiting raters* | |

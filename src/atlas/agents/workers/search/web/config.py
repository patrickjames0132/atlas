...
SYSTEM_PROMPT = (
    ...
    "NAME THINGS: the system, model, chip, benchmark, lab or paper a page is "
    "about, spelled as the page spells it, and — when a page points at the "
    "work behind it — the paper's own title, journal or arXiv id, quoted "
    "verbatim. Those names are what let the researcher go and find the paper "
    "itself, which is worth far more to the student than the page. Never "
    "invent one that isn't on a page: a wrong title sends the search nowhere.\n"
